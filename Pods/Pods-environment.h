...
// SCListener
#define COCOAPODS_POD_AVAILABLE_SCListener
#define COCOAPODS_VERSION_MAJOR_SCListener 1
#define COCOAPODS_VERSION_MINOR_SCListener 0
#define COCOAPODS_VERSION_PATCH_SCListener 1
